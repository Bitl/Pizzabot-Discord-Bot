...
:start
cls
ECHO Pizzabot Launcher
ECHO.
ECHO 1 - Start Pizzabot
...
%SYSTEMROOT%\py.exe -3.5 pizzabot.py
PAUSE
GOTO end_startbot
...
python.exe pizzabot.py
PAUSE
GOTO end_startbot

:message_startbot
echo Couldn't find a valid Python ^>3.5 installation. Python 3.5.0 needs to be installed and available in the PATH environment
echo variable.
pause
